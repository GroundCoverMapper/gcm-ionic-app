  ...
  <ion-page>
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title><a href="/home" class="homelink">GCM</a> - Configuration</ion-title>
      </ion-toolbar>
    </ion-header>
...
<BR/><BR/>
	...
	<li> Jobs </li>
	<li> plots and sampling instructions </li>
	<li> transects to plots </li>
	<li> Sampling density</li>
	<li> Teams assignments</li>
	<li> Data export</li>
